...
const EditDonation = () => {
  ...
  useEffect(() => {
    axios
      .get("https://api.masjidal-irsyad.com/api/donations")
      .then((res) => {
        const result = res.data.find((donations) => donations.slug === slug);
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://api.masjidal-irsyad.com/api/donations/" + slug, formData)
      .then(() => {

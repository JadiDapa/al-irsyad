...
const EditFinancial = () => {
  ...
  const [valueVd, setValueVd] = useState("");
  const [statusVd, setStatusVd] = useState("");
  const [contentVd, setContentVd] = useState("");
  const [titleError, setTitleError] = useState("");

  const everything = titleVd || statusVd || valueVd || contentVd;

  useEffect(() => {
    axios
      .get("https://api.masjidal-irsyad.com/api/financials")
      .then((res) => {
        const result = res.data.find((financials) => financials.slug === slug);
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://api.masjidal-irsyad.com/api/financials/" + slug, formData)
      .then(() => {
